...
import { CalendarIcon, Loader2, ChevronLeft, ChevronRight, CheckCircle2 } from "lucide-react";
...
interface WizardStep {
  ...
  title: string;
  description: string;
  fields: (keyof UGCScriptFormData)[];
}
...
const WIZARD_STEPS: WizardStep[] = [
  {
    ...
    description: "Información básica sobre el cliente y los creadores necesarios. Esta información nos ayuda a seleccionar el perfil de creadores ideal para tu campaña.",
    fields: ["client_name", "cantidad_creadores", "especificaciones_creadores"]
  },
  {
    id: 2,
    title: "Especificaciones del video",
    description: "Detalles técnicos del video que definirán el formato y duración final. La duración óptima mejora el engagement en cada plataforma.",
    fields: ["video_duration", "video_duration_other"]
  },
  {
    id: 3,
    title: "Especificaciones del producto",
    description: "Detalles sobre cómo mostrar tu producto o servicio. El timing correcto del producto maximiza las conversiones y reduce la percepción publicitaria.",
    fields: ["product_display_timing", "recording_formats", "recording_formats_other", "existing_script_links", "delivery_deadline"]
  },
  {
    id: 4,
    title: "Instrucciones de producción",
    description: "Guía específica para el proceso de grabación y producción. Estos detalles aseguran coherencia visual y profesionalismo en todos los videos.",
    fields: ["app_parts_to_show", "recording_locations", "creator_clothing", "creator_clothing_other", "creator_appearance_style", "creator_appearance_style_other", "creator_activity_while_talking"]
  },
  {
    id: 5,
    title: "Configuración para apps",
    description: "Especificaciones técnicas para mostrar aplicaciones móviles o web. El método de presentación afecta directamente la comprensión del usuario.",
    fields: ["app_display_method"]
  },
  {
    id: 6,
    title: "Estilo y guion",
    description: "Directrices sobre el estilo narrativo y la pronunciación. Un enfoque consistente en el lenguaje fortalece la identidad de marca en todos los videos.",
    fields: ["script_adherence", "creator_speech_style", "brand_pronunciation_guide"]
  },
  {
    id: 7,
    title: "Objetivos y estrategia",
    description: "Objetivos de marketing y mensajes clave a transmitir. Una estrategia clara optimiza el impacto y la efectividad de cada video para tu audiencia objetivo.",
    fields: ["main_objective", "key_message", "brand_values", "target_audience", "product_or_service", "key_features_benefits", "technical_details", "video_tone", "reference_ugc_videos", "call_to_action", "competitive_differentiators"]
  },
  {
    id: 8,
    title: "Información adicional",
    description: "Detalles extras y consideraciones especiales. Cualquier información adicional nos ayuda a crear videos más personalizados y efectivos.",
    fields: ["additional_details"]
  }
];

interface UGCScriptFormWizardProps {
  isCollapsed?: boolean;
}

export default function UGCScriptFormWizard({ isCollapsed = false }: UGCScriptFormWizardProps) {
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              {isFormSubmitted && <CheckCircle2 className="h-5 w-5 text-green-500" />}
              <div>
                <CardTitle className="text-lg">Formulario UGC Script</CardTitle>
                <CardDescription>
                  {isFormSubmitted 
  ...
  return (
    <div className="space-y-6">
      {/* Header con descripción inicial */}
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Formulario de Producción de Guiones UGC</CardTitle>
          <CardDescription className="text-base">
            <strong>Cuanto mejor y más detalles se nos dé en la respuesta, mejor van a ser los videos creados.</strong><br/>
            Para asegurarnos de que los videos UGC que creamos para tu campaña sean exactamente lo que necesitas, 
